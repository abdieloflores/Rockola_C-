        ...
        switch (option)
        {
            case 1:
                if (Disc == NULL) {
                    system("clear");
                    finish2 = 0;
                    system("afplay /Users/oto/Desktop/Repositorios_GIT/Rockola_C-/Rockola/Music/Fail.mp3  &>/dev/null &");
            ...
            case 3:
                ...
                system("afplay /Users/oto/Desktop/Repositorios_GIT/Rockola_C-/Rockola/Music/Correct.mp3  &>/dev/null &");
            ...
            case 8:
                Songs->Destroy(Song);
                Discs->Destroy(Disc);
                system("afplay /Users/oto/Desktop/Repositorios_GIT/Rockola_C-/Rockola/Music/Close.mp3 &>/dev/null &");
                finish=0;
                exit(1);
                break;
            default:
...
void Menu::songsMenu(NodoDisc *_Disc)
{
    ...
    string carpet = "/Users/oto/Desktop/Repositorios_GIT/Rockola_C-/Rockola/Music/";
